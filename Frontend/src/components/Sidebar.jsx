...
import { ShipWheelIcon, UsersIcon, HomeIcon, BellIcon } from 'lucide-react'
  ...
  return (
    <aside className='w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0'>
      ...
      <nav className='flex-1 p-4 space-y-1'>
        ...
        {/* if friends route it becomes active */}
      ...
      {/* Add additional sidebar items here (navigation, profile, etc.) */}
